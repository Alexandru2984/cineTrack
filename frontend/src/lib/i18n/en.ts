...
export const en = {
  ...
  media: {
    ...
    rewatchEpisode: 'Watch episode again',
    timesWatched: 'Seen {count}×',
    seenTimes_one: 'You have seen this once',
    seenTimes_other: 'You have seen this {count} times',
  ...
  listDetail: {
    ...
    emptyOwner: 'Add titles from your library below, or open any film or show and use “Custom list”.',
    addTitle: 'Add from your library',
    addFilter: 'Filter your library',
    addLoading: 'Loading your library…',
    addNoMatch: 'Nothing in your library matches that.',
    addNoLibrary: 'Your library is empty. Mark something watched and it will appear here.',
    addAlready: 'Added',
