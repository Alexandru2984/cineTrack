...
- **Supply-chain checks** — Rust licenses, duplicate crates, wildcard dependencies and package sources; npm licenses, registry origins and SHA-512 lockfile integrity; plus vulnerability audits and PR dependency review
