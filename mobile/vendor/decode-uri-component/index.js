// Vendored from decode-uri-component 0.5.0, converted to CommonJS.
//
// `query-string@7.1.3` requires this with `require()`, and 0.5.0 is ESM-only —
// forcing it through `overrides` resolves but breaks at runtime. Everything
// below is upstream's; the only edits are the export at the bottom and this
// note. See README.md for why the version `query-string` asks for cannot be
// used, and for what makes it safe to delete.
