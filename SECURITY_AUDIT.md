...
- The native client now covers social/follow flows, notifications, detailed statistics, account/privacy/session settings and deletion, watch history/rewatches, custom lists, ratings/reviews, tracking, Calendar, and offline reads. TV Time import remains intentionally web-only; avatar upload and push delivery are still pending native work.
